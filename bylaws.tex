...
\externaldocument{articles}[https://github.com/ComputerScienceHouse/Constitution/blob/master/articles.pdf?raw=true]
...
\newcommand{\itemname}[2]{#1 & #2 \\ \hline\hline}
\newcommand{\lineitem}[2]{#1 & #2\% \\ \hline}
...
\begin{budget}
  \itemname{Directorship Name}          {Percentage of Dues}

  \lineitem{Operational Communications} {20}
  \lineitem{Evaluations \& Selections}  {5}
  \lineitem{House History}              {10}
  \lineitem{House Improvements}         {15}
  \lineitem{Research and Development}   {20}
  \lineitem{Social}                     {20}
  \lineitem{Accumulated}                {10}
\end{budget}
